...
def download_deep_residual():
    print('Downloading deep residual model from https://d2j0dndfm35trm.cloudfront.net/resnet-152.t7')
    os.system('wget https://d2j0dndfm35trm.cloudfront.net/resnet-152.t7')

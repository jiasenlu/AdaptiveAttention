...
def build_vocab(imgs, params):
  ...
  for img in imgs:
    img['final_captions'] = []
    for txt in img['sentences']:
      caption = [w if counts.get(w,0) > count_thr else 'UNK' for w in txt['tokens']]
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/data/flickr30k/dataset.json', help='input json file to process into hdf5')
  parser.add_argument('--output_json', default='/data/flickr30k/cocotalk.json', help='output json file')
  parser.add_argument('--output_h5', default='/data/flickr30k/cocotalk.h5', help='output h5 file')
  
  # options
  parser.add_argument('--max_length', default=16, type=int, help='max length of a caption, in number of words. captions longer than this get clipped.')
  parser.add_argument('--images_root', default='/data/flickr30k/images', help='root location in which images are stored, to be prepended to file_path in input json')

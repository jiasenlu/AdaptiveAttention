...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/data/coco/coco_val_raw.json', help='input json file to process into hdf5')
  parser.add_argument('--output_json', default='/data/coco/cocotalk_val.json', help='output json file')
  parser.add_argument('--output_h5', default='/data/coco/cocotalk_val.h5', help='output h5 file')
